...
<div style="float:left; width: 33%; margin:30px;">
	...
	제목: <input type="text" name="storyTitle" required="required" value="${story.storyTitle}"><br><br>
	<span id="showUpdate">
	<c:choose>
		<c:when test="${story.storyPictureUrl!=null}">
			${story.storyPictureUrl}<a href="javascript:startRequest()">파일 삭제</a><br>
			<input type="hidden" name="storyPictureUrl" value="${story.storyPictureUrl}">
		</c:when>
		<c:otherwise>
	...
	내용: <textarea rows="20" cols="30" name="storyContent" style="height: 180px; width: 400px">${story.storyContent}</textarea><br>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<c:if test="${story.storyIsPublic=='public'}">
		<c:out value="${story.storyIsPublic}"></c:out>
	...
	<c:if test="${story.storyIsPublic=='private'}">
		<c:out value="${story.storyIsPublic}"></c:out>
		<input type="checkbox" name="storyIsPublic" value="public" onclick="checkBox(0)">공개
		<input type="checkbox" name="storyIsPublic" value="private" onclick="checkBox(1)" checked="checked">비공개
	</c:if>
	
	<br><br>
	위도: <input type="text" name="storyLatitude" value="${story.storyLatitude}"><br>
	경도: <input type="text" name="storyLongitude" value="${story.storyLongitude}"><br>
	위치: <input type="text" name="storyLocation" value="${story.storyLocation}"><br><br>
	<input type="submit" value="수정">
</form>
</div>
<div id="mapLayout" style="float:left; width: 33%; margin:30px;">
	SEARCH LOCATION<br>
	<input id="pac-input" class="controls" type="text" placeholder="Enter a location">
	<div id="map" style="width:420px; height:350px;">
</div><br><br>
</div>
	<!-- --------------------------------------------- [시작] Footer --------------------------------------------- -->
	<footer id="footer">
